  ...
  ?>
    ...
    <article class="wrapTable">
      <table>
        <tr>
          ...
          <td>농가명</td>
          <td>주소</td>
          <td style="width : 60px">사육 규모<br />(수)</td>
          <td style="width : 60px">생산량</td>
          <td style="width : 60px">인증 사항</td>
          <td style="width : 60px">검사 기관</td>
          <td style="width : 80px">시료 채취일</td>
    ...
    if (screen.availWidth < 800) {
      ...
      $(window).scroll(function() {
        ...
        else if ($(window).scrollTop() <= 400 && $(window).scrollTop() >  headerSize+50) {
